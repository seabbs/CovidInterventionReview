...
Where possible, information on the intervention and the date they were implemented were extracted from official government sources such as Ministry of Education websites (see supplementary table X). We categorised the SD measures into 7 broad categories as summarised in Table 1. Information and dates of other non-pharmaceutical interventions, aside from SD measures, implemented early on in the epidemic such as travel advisories were also extracted (Table S1).
